...
-- CreateEnum
CREATE TYPE "EthinictyEnum" AS ENUM ('White', 'Black', 'AsianAmerican', 'EastAsian', 'SouthEastAsian', 'SouthAsianMiddle', 'Eastern', 'Pacific', 'Hispanic');
...
CREATE TABLE "Model" (
    ...
    "ethinicity" "EthinictyEnum" NOT NULL,
